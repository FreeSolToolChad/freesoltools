...
export const metadata: Metadata = {
  title: 'FreeSolTools vs ClaimFreeSOL | 100% Free SOL Recovery',
  description: 'Compare FreeSolTools to ClaimFreeSOL. Keep 100% of your recovered SOL rent with our 0% fee token account cleaner.',
};

export default function VsClaimFreeSolPage() {
  return (
    <main className="max-w-4xl mx-auto px-4 py-16 text-zinc-300 space-y-12 selection:bg-[#e2fbff]/30">
      <div className="text-center space-y-4">
        <div className="flex items-center justify-center gap-6 mb-2">
          ...
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src="/images/claimfreesol-logo.png" alt="ClaimFreeSOL Logo" className="w-16 h-16 rounded-xl object-contain bg-zinc-800" />
        </div>
        <h1 className="text-4xl md:text-5xl font-extrabold text-white">
          FreeSolTools vs <span className="text-purple-400">ClaimFreeSOL</span>
        </h1>
          ...
          <thead>
            <tr className="border-b border-zinc-800">
              ...
              <th className="p-4 font-semibold text-zinc-500">
                <div className="flex items-center gap-2">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img src="/images/claimfreesol-logo.png" alt="ClaimFreeSOL" className="w-6 h-6 rounded-md object-contain bg-zinc-800" />
                  ClaimFreeSOL
                </div>
              </th>
            </tr>
      ...
      <div className="space-y-6 bg-zinc-900/50 p-8 rounded-2xl border border-zinc-800">
        ...
        <p className="leading-relaxed text-zinc-400">
          Tools like ClaimFreeSOL take a fraction of the rent exemption from every account you close. This means you are essentially paying them your own money just to interact with the Solana blockchain.
        </p>
        <p className="leading-relaxed text-zinc-400">
