...
export const metadata: Metadata = {
  title: 'FreeSolTools vs ClaimYourSOLs | The Best Solana Account Cleaner',
  description: 'Compare FreeSolTools to ClaimYourSOLs. Keep 100% of your recovered SOL rent with our 0% fee token account cleaner.',
};

export default function VsClaimYourSolsPage() {
  return (
    <main className="max-w-4xl mx-auto px-4 py-16 text-zinc-300 space-y-12 selection:bg-[#e2fbff]/30">
      <div className="text-center space-y-4">
        <div className="flex items-center justify-center gap-6 mb-2">
          ...
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src="/images/claimyoursols-logo.png" alt="ClaimYourSOLs Logo" className="w-16 h-16 rounded-xl object-contain bg-zinc-800" />
        </div>
        <h1 className="text-4xl md:text-5xl font-extrabold text-white">
          FreeSolTools vs <span className="text-red-400">ClaimYourSOLs</span>
        </h1>
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="border-b border-zinc-800">
              ...
              <th className="p-4 font-semibold text-zinc-500">
                <div className="flex items-center gap-2">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img src="/images/claimyoursols-logo.png" alt="ClaimYourSOLs" className="w-6 h-6 rounded-md object-contain bg-zinc-800" />
                  ClaimYourSOLs
                </div>
              </th>
            </tr>
          ...
          <tbody className="divide-y divide-zinc-800">
            <tr>
              ...
              <td className="p-4 text-zinc-400">~10%</td>
            </tr>
            <tr>
              ...
              <td className="p-4 font-bold text-red-400">~0.0018 SOL</td>
            </tr>
            <tr>
              ...
              <td className="p-4 font-bold text-red-400">~0.09 SOL</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <div className="space-y-6 bg-zinc-900/50 p-8 rounded-2xl border border-zinc-800">
        ...
        <p className="leading-relaxed text-zinc-400">
          Tools like ClaimYourSOLs take a fraction of the rent exemption from every account you close. This means you are essentially paying them your own money just to interact with the Solana blockchain.
        </p>
        <p className="leading-relaxed text-zinc-400">
