...
export const metadata: Metadata = {
  title: 'FreeSolTools | The #1 Zero-Fee Solana Wallet Cleaner',
  description: 'Easily scan your Solana wallet to find and close empty SPL token accounts. Recover ~0.002 SOL for every account safely, with exactly 0% platform fees.',
  openGraph: {
    title: 'FreeSolTools | The #1 Zero-Fee Solana Wallet Cleaner',
    description: 'Easily scan your Solana wallet to find and close empty SPL token accounts. Recover ~0.002 SOL for every account safely, with exactly 0% platform fees.',
    type: 'website',
      ...
      <section className="pt-6 pb-6 px-4 border-b border-zinc-800/50 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-4 relative z-10">
          ...
          <h1 className="text-3xl md:text-5xl lg:text-6xl font-extrabold tracking-tight">
            Recover your trapped SOL. Keep 100%. <br className="hidden md:block"/>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#e2fbff] to-[#c2f6ff]">No hidden fee.</span>
          </h1>
          
          <p className="text-base md:text-lg text-zinc-400 max-w-2xl mx-auto font-medium leading-relaxed">
            Your SOL is trapped in empty token accounts. Competitors charge 20% to clean them. We charge exactly <span className="text-white font-bold">0%</span>. Recover your rent safely and keep 100% of your money.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-4xl mx-auto px-4 py-8 space-y-8">
        ...
        <div className="text-center pt-16 space-y-6">
          ...
          <p className="text-zinc-400 text-sm max-w-2xl mx-auto leading-relaxed">
            ...
            Even after selling or sending tokens, these empty accounts stay in your wallet, holding your SOL hostage!
          </p>
          ...
          <div className="space-y-4 text-left max-w-2xl mx-auto bg-zinc-900 p-6 rounded-2xl border border-zinc-800">
            ...
            <ul className="list-disc list-outside ml-4 space-y-2 text-sm text-zinc-400">
              <li>We automatically detect every empty token account in your wallet</li>
              <li>We minimize your effort by consolidating the maximum amount of closed accounts into a single transaction</li>
              <li>Close your accounts safely with just one click</li>
              <li>Instantly recover your locked SOL</li>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "name": "SolFree Tools - Sol Cleaner",
            ...
            "description": "Scan your Solana wallet and close empty token accounts to recover locked SOL rent with 0% platform fees."
          })
        }}
      />
    </main>
